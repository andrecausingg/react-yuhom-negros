  ...
  return (
    ...
    <div className="yot-pa-16 yot-content-space-mt-120 yot-container">
        ...
        <div className='yot-text-center'>
          <p data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-delay="500" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-once="true">Welcome to Uncover Negro's Treasures! We are a passionate team of travel enthusiasts dedicated to 
...
stories that make this region truly special.</p>
          <div className='yot-row-m yot-flex-ai-c-jc-c yot-mt-16'>
              <div className='yot-relative' data-aos="zoom-in-right" data-aos-delay="500" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-once="true">
              ...
              <div className='yot-relative' data-aos="zoom-in-left" data-aos-delay="500" data-aos-duration="500" data-aos-easing="ease-in-out" data-aos-once="true">
